...
class _OrderDetailsState extends State<OrderDetails> {
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.order["status"] == "done") {
      ...
      icon = Icons.cancel;
      status = -1;
    } else if (widget.order["status"] == "onTheWay") {
              ...
              theBoxShape(
                Column(
                  ...
                  children: [
                    ...
                    //=========== طرق الدفع =========
                    boxBody("طرق الدفع", "${widget.order["payment"]}"),
                    Divider(
                      color: color.g400,
                      height: 0,
                    ),
                ...
                Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                          boxBody("الاجمالي", "${widget.order["total"]} \$",
                              st: fonts.lb, isprice: true),
                          SizedBox(
                            height: 4,
                          ),
                          boxBody(
                              "سعر التوصيل", "${widget.order["delivery"]} \$",
